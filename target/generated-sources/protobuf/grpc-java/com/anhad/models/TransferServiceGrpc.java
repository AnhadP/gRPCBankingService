...
public final class TransferServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.anhad.models.TransferRequest,
      com.anhad.models.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "transfer",
      requestType = com.anhad.models.TransferRequest.class,
      responseType = com.anhad.models.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.anhad.models.TransferRequest,
      com.anhad.models.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<com.anhad.models.TransferRequest, com.anhad.models.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod =
              io.grpc.MethodDescriptor.<com.anhad.models.TransferRequest, com.anhad.models.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.TransferResponse.getDefaultInstance()))
  ...
  public static abstract class TransferServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.anhad.models.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.anhad.models.TransferResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                com.anhad.models.TransferRequest,
                com.anhad.models.TransferResponse>(
  ...
  private static abstract class TransferServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.anhad.models.TransferServiceOuterClass.getDescriptor();
    }
