...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.anhad.models.BalanceCheckRequest,
      com.anhad.models.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.anhad.models.BalanceCheckRequest.class,
      responseType = com.anhad.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.anhad.models.BalanceCheckRequest,
      com.anhad.models.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.anhad.models.BalanceCheckRequest, com.anhad.models.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.anhad.models.BalanceCheckRequest, com.anhad.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.Balance.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.anhad.models.WithdrawRequest,
      com.anhad.models.Money> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "withdraw",
      requestType = com.anhad.models.WithdrawRequest.class,
      responseType = com.anhad.models.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.anhad.models.WithdrawRequest,
      com.anhad.models.Money> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.anhad.models.WithdrawRequest, com.anhad.models.Money> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.anhad.models.WithdrawRequest, com.anhad.models.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.Money.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.anhad.models.DepositRequest,
      com.anhad.models.Balance> getCashDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cashDeposit",
      requestType = com.anhad.models.DepositRequest.class,
      responseType = com.anhad.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.anhad.models.DepositRequest,
      com.anhad.models.Balance> getCashDepositMethod() {
    io.grpc.MethodDescriptor<com.anhad.models.DepositRequest, com.anhad.models.Balance> getCashDepositMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getCashDepositMethod = BankServiceGrpc.getCashDepositMethod) == null) {
          BankServiceGrpc.getCashDepositMethod = getCashDepositMethod =
              io.grpc.MethodDescriptor.<com.anhad.models.DepositRequest, com.anhad.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "cashDeposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.DepositRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.anhad.models.Balance.getDefaultInstance()))
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getBalance(com.anhad.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.anhad.models.Balance> responseObserver) {
     ...
     * </pre>
     */
    public void withdraw(com.anhad.models.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.anhad.models.Money> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.anhad.models.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.anhad.models.Balance> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.anhad.models.BalanceCheckRequest,
                com.anhad.models.Balance>(
                  this, METHODID_GET_BALANCE)))
          .addMethod(
            getWithdrawMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.anhad.models.WithdrawRequest,
                com.anhad.models.Money>(
                  this, METHODID_WITHDRAW)))
          .addMethod(
            getCashDepositMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                com.anhad.models.DepositRequest,
                com.anhad.models.Balance>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.anhad.models.Balance getBalance(com.anhad.models.BalanceCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.anhad.models.Money> withdraw(
        com.anhad.models.WithdrawRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BankServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.anhad.models.Balance> getBalance(
        com.anhad.models.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.anhad.models.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.anhad.models.Balance>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.anhad.models.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.anhad.models.Money>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.anhad.models.BankServiceOuterClass.getDescriptor();
    }
